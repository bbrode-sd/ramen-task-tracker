                      ...
                      {isEditing ? (
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-end gap-2">
                            ...
                            <button
                              onClick={() => handleSaveEdit(tag.id, originalLang)}
                              disabled={isTranslating}
                              className="px-3 py-1.5 text-sm bg-emerald-500 hover:bg-emerald-600 disabled:bg-gray-400 text-white rounded-lg transition-colors flex items-center gap-1.5"
                            >
                              {isTranslating && (
